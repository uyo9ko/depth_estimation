...
class Decoder(nn.Module):
    def __init__(self, num_features=1664, decoder_width=0.5):
        ...
        self.up1 = UpSample(features // 1 + 256, features // 2)
        self.up2 = UpSample(features // 2 + 128, features // 4)
        self.up3 = UpSample(features // 4 + 64, features // 8)
        self.up4 = UpSample(features // 8 + 64, features // 16)
    ...
    def forward(self, features):
        ...
        # print('x_block0.shape:', x_block0.shape)
        # print('x_block1.shape:', x_block1.shape)
        # print('x_block2.shape:', x_block2.shape)
        # print('x_block3.shape:', x_block3.shape)
        # print('x_block4.shape:', x_block4.shape)
...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        # self.original_model = densenet169_ibn_a(pretrained=True)
        # print(self.original_model.features._modules.items())
